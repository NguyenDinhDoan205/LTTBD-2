  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.messageContainer}>
        <Text style={styles.messageLabel1}>Nguyễn Đình Đoán (+84)97*****74</Text>
      </View>
      <Text style={styles.messageLite1}>Chung Cư The Sun Avenue, SAV6-19.02, 28 Mai Chí Thọ, An Phú, Quận 2, TP.Thủ Đức</Text>
