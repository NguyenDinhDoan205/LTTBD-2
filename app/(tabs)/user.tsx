...
export default function LoginScreen() {
  ...
  const handleLogin = () => {
    ...
    if (trimmedUsername === '0975754874' && trimmedPassword === '1') {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require('../../assets/images/logo.jpg')} // Correctly reference the image
        style={styles.logo}
        resizeMode="contain"
      />
      ...
      <Modal isVisible={isModalVisible}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalMessage}>
            Mã OTP của bạn là: <Text style={styles.otpCode}>4187</Text>
          </Text>
          <Text style={styles.modalMessage}>
